...
def render_html_content(
    ...
    *,
    ...
    <head>
        ...
        <title>热点新闻分析</title>
        <link rel="shortcut icon" href="https://hangcv.cc.cd/file/AgACAgUAAyEGAATfLmpgAAMQaehclPz88BS-NYW7WMep0NZWL8YAAsIQaxvnvUlXW0g8Nq0wftMBAAMCAANtAAM7BA.png" type="image/x-icon">
